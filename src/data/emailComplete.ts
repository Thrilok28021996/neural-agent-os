...
export function generateEmailDraft(workspaceId: string, instructions: string, context: string, model?: string) { return invoke<string>('generate_email_draft', { workspaceId, instructions, context, model: model ?? DEFAULT_LMSTUDIO_MODEL }) }
export function summarizeEmailThread(threadId: string, workspaceId: string, model?: string) { return invoke<string>('summarize_email_thread', { threadId, workspaceId, model: model ?? DEFAULT_LMSTUDIO_MODEL }) }
export function extractEmailActionsFromEmail(emailId: string, workspaceId: string, model?: string) { return invoke<string[]>('extract_email_actions', { emailId, workspaceId, model: model ?? DEFAULT_LMSTUDIO_MODEL }) }
